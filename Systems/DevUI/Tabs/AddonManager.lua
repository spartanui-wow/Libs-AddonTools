...
function BuildContent(contentFrame)
	...
	TabState.LeftPanel:SetPoint('TOPLEFT', container, 'TOPLEFT', 4, -4)
	TabState.LeftPanel:SetPoint('BOTTOMLEFT', container, 'BOTTOMLEFT', 4, 40)
	TabState.LeftPanel:SetWidth(160)

	-- CENTER PANEL: Addon List (50% width)
	TabState.CenterPanel = CreateFrame('Frame', nil, container, 'InsetFrameTemplate3')
	TabState.CenterPanel:SetPoint('TOPLEFT', TabState.LeftPanel, 'TOPRIGHT', 4, 0)
	TabState.CenterPanel:SetPoint('BOTTOMLEFT', TabState.LeftPanel, 'BOTTOMRIGHT', 4, 0)
	TabState.CenterPanel:SetWidth(360)

	-- RIGHT PANEL: Details (30% width)
	TabState.RightPanel = CreateFrame('Frame', nil, container, 'InsetFrameTemplate3')
	TabState.RightPanel:SetPoint('TOPLEFT', TabState.CenterPanel, 'TOPRIGHT', 4, 0)
	TabState.RightPanel:SetPoint('BOTTOMRIGHT', container, 'BOTTOMRIGHT', -4, 40)
